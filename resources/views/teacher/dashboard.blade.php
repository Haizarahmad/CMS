...
@section('teacher-content')
    ...
    <hr class="my-4" />
    <div class="flex items-center justify-between p-4 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
    ...
    <div class="grid 2xl:grid-cols-3 grid-rows-2 gap-6 mt-4">
        ...
        <div class="flex flex-col items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 2xl:col-span-1">
            <h1 class="text-xl font-medium text-gray-600 dark:text-gray-400">Students by gender</h1>
